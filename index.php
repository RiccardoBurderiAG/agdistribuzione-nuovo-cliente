            ...
            <form method="post" id="nuovoClienteForm" enctype="multipart/form-data">
                ...
                <div class="inputGroupContainer">
                    <div class="inputContainer">
                        ...
                        <span class="error_input"><?php echo $codiceagente_error;?></span>
                    </div>
                    <div class="inputContainer">
                ...
                <div class="inputGroupContainer">
                    <div class="inputContainer">
                        ...
                        <input type="email_cliente" id="email_cliente" name="email_cliente" placeholder="Indirizzo Email*" >
                    </div>
                    <div class="inputContainer">
                ...
                <div class="inputGroupContainer">
                    ...
                    <div class="inputContainer">
                        ...
                        <input type="text" id="cap" name="cap" placeholder="Cap*"  pattern="[0-9]{5}">
                    </div>
                </div>
                <div class="inputGroupContainer">
                    <div class="inputContainer">
                ...
                <div class="inputGroupContainer">
                    <div class="inputContainer">
                        ...
                        <input type="text" id="vat" name="vat" placeholder="Partita IVA*"  pattern="[0-9]{11}">
                    </div>
                    <div class="inputContainer">
                        <label for="unique_code">Codice Univoco<div class="labelStrong">obbligatorio</div></label>
                        <input type="text" id="unique_code" name="unique_code" placeholder="Codice Univoco*" >
                    </div>
                </div>
